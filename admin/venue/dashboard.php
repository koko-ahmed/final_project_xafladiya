...
if ($search !== '') {
    ...
    $query .= " WHERE name LIKE '%$search_escaped%' OR location LIKE '%$search_escaped%' OR contact_name LIKE '%$search_escaped%' OR contact_phone LIKE '%$search_escaped%'";
}
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4 mt-5">
            ...
            <form method="get" class="mb-3" style="max-width: 400px;">
                <div class="input-group">
                    <input type="text" name="search" class="form-control" placeholder="Search venues..." value="<?php echo htmlspecialchars($search); ?>">
                        ...
                        <?php else: ?>
                            <?php foreach ($venues as $venue): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="edit_venue.php?id=<?php echo $venue['id']; ?>" class="btn btn-sm btn-success me-2">
