...
<body>
    ...
    <!-- Top Cities Section -->
    <section class="top-cities-section py-5" data-aos="fade-up" style="background: #f9fafb;">
    <div class="container">
        <h2 class="text-center fw-bold mb-4" style="color: #1976d2;">Top Cities</h2>
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item active">
                    <div class="row justify-content-center">
                        <div class="col-md-4">
                            <div class="city-card shadow-sm rounded-4 p-4 text-center bg-white">
                                <img src="https://images.unsplash.com/photo-1506744038136-46273834b3fb?w=600&auto=format&fit=crop&q=60" alt="Mogadishu" class="img-fluid rounded-3 mb-3" style="height:200px; object-fit:cover; border-radius: 12px;">
                                <h5 class="fw-bold mb-1">Mogadishu</h5>
                                <div class="rating mb-2">
                                    <span class="star">★</span><span class="star">★</span><span class="star">★</span><span class="star">★</span><span class="star">★</span>
                                </div>
                                <p class="text-muted small">The vibrant capital city with a rich history and beautiful coastline.</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="city-card shadow-sm rounded-4 p-4 text-center bg-white">
                                <img src="https://images.unsplash.com/photo-1494526585095-c41746248156?w=600&auto=format&fit=crop&q=60" alt="Hargeisa" class="img-fluid rounded-3 mb-3" style="height:200px; object-fit:cover; border-radius: 12px;">
                                <h5 class="fw-bold mb-1">Hargeisa</h5>
                                <div class="rating mb-2">
                                    <span class="star">★</span><span class="star">★</span><span class="star">★</span><span class="star">★</span><span class="star star-muted">☆</span>
                                </div>
                                <p class="text-muted small">A bustling city known for its lively markets and surrounding natural beauty.</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="city-card shadow-sm rounded-4 p-4 text-center bg-white">
                                <img src="https://images.unsplash.com/photo-1501594907352-04cda38ebc29?w=600&auto=format&fit=crop&q=60" alt="Bosaso" class="img-fluid rounded-3 mb-3" style="height:200px; object-fit:cover; border-radius: 12px;">
                                <h5 class="fw-bold mb-1">Bosaso</h5>
                                <div class="rating mb-2">
                                ...
                                <p class="text-muted small">A key port city in the north, known for its trade and coastal views.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="carousel-item">
                    <div class="row justify-content-center">
                        <div class="col-md-4">
                            <div class="city-card shadow-sm rounded-4 p-4 text-center bg-white">
                                <img src="https://images.unsplash.com/photo-1506748686214-e9df14d4d9d0?w=600&auto=format&fit=crop&q=60" alt="Kismayo" class="img-fluid rounded-3 mb-3" style="height:200px; object-fit:cover; border-radius: 12px;">
                                <h5 class="fw-bold mb-1">Kismayo</h5>
                                <div class="rating mb-2">
                                    <span class="star">★</span><span class="star">★</span><span class="star">★</span><span class="star">★</span><span class="star star-muted">☆</span>
                                </div>
                                <p class="text-muted small">A southern port city with beautiful beaches and historical significance.</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="city-card shadow-sm rounded-4 p-4 text-center bg-white">
                                <img src="https://images.unsplash.com/photo-1477959858617-67f85cf4f1df?w=600&auto=format&fit=crop&q=60" alt="Garowe" class="img-fluid rounded-3 mb-3" style="height:200px; object-fit:cover; border-radius: 12px;">
                                <h5 class="fw-bold mb-1">Garowe</h5>
                                <div class="rating mb-2">
                                    <span class="star">★</span><span class="star">★</span><span class="star">★</span><span class="star">★</span><span class="star star-muted">☆</span>
                                </div>
                                <p class="text-muted small">The administrative capital of Puntland, known for its development.</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="city-card shadow-sm rounded-4 p-4 text-center bg-white">
                                <img src="https://images.unsplash.com/photo-1561488111-5d800fd56b8a?w=600&auto=format&fit=crop&q=60" alt="Burao" class="img-fluid rounded-3 mb-3" style="height:200px; object-fit:cover; border-radius: 12px;">
                                <h5 class="fw-bold mb-1">Burao</h5>
                                <div class="rating mb-2">
                                    <span class="star">★</span><span class="star">★</span><span class="star">★</span><span class="star">★</span><span class="star">★</span>
                                </div>
                                <p class="text-muted small">A major city in Somaliland, famous for its livestock market.</p>
                            </div>
                        </div>
                    </div>
                </div>
